...
# Model for VQA
VQA_MODEL_NAME = os.environ.get("VQA_MODEL_NAME")
...
def create_mcp_server_parameters(
    cfg: DictConfig, agent_cfg: DictConfig, custom_env: Dict = {}
):
        ...
        configs.append(
            {
                ...
                "params": StdioServerParameters(
                    ...
                    env={"E2B_API_KEY": E2B_API_KEY, **custom_env},
                ),
            }
        )
    ...
    if (
        ...
        if not SERPER_API_KEY:
            raise ValueError(
                "SERPER_API_KEY not set, tool-image-search will be unavailable."
            )
        ...
        configs.append(
            {
                ...
                "params": StdioServerParameters(
                    ...
                    args=[
                        "-m",
                        "miroflow_tools.mcp_servers.searching_image_mcp_server",
                    ],
                    env={
                        "SERPER_API_KEY": SERPER_API_KEY,
                        "SERPER_BASE_URL": SERPER_BASE_URL,
